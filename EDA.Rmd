...
```{r num_protein_lollipop, fig.asp=1.7}
# Lollipop plot
ggplot(plot_data) +
...
```{r num_protein_boxplot, fig.asp=0.6}
# Boxplot
...
```{r num_protein_density, fig.asp = 0.6}
ggplot(plot_data) +
...
```{r pca-plot-pretty, fig.cap="This is the figure caption"}
# New legend title
